...
ll Dis(pair <ll , ll> a , pair <ll , ll> b) {
    ll ans = Sqr(a.second - b.second) + Sqr(a.first - b.first);
    return ans;
} 
int main() {
    FasterIO
    Test {
        ...
        v.push_back(make_pair(Dis(tmp , a[0]) , a[0]));
        v.push_back(make_pair(Dis(tmp , a[1]) , a[1]));
        v.push_back(make_pair(Dis(tmp , a[2]) , a[2]));
        v.push_back(make_pair(Dis(tmp , a[3]) , a[3]));
        sort(v.rbegin() , v.rend());
        ans = v[0].second;
        v.clear();
        v.push_back(make_pair(Dis(ans , a[0]) , a[0]));
        v.push_back(make_pair(Dis(ans , a[1]) , a[1]));
        v.push_back(make_pair(Dis(ans , a[2]) , a[2]));
        v.push_back(make_pair(Dis(ans , a[3]) , a[3]));
        sort(v.rbegin() , v.rend());
